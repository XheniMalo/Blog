...
<body>
    ...
    <div class="profile-container">
        <div class="profile-details">
            ...
            <form method="POST" action="/Project1/adminprofile">
                ...
                <div class="buttons">
                    <button type="button" name="security" class="btn btn-primary"
                        onclick="window.location.href='/Project1/passwordadmin'">Security</button>
                </div>
        ...
        <form enctype="multipart/form-data" action="/Project1/adminpic" method="post">
